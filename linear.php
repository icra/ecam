...
<div id=linearDiagram>
	<div>
		...
		<img class=l2 stage=waterAbs src=img/waterAbs.png onclick=window.location="level3.php?level=Water&sublevel=Abstraction"  title="Abstraction (L2)" >
		<img class=l2 stage=waterTre src=img/waterTre.png onclick=window.location="level3.php?level=Water&sublevel=Treatment"    title="Treatment (L2)">
		<img class=l2 stage=waterDis src=img/waterDis.png onclick=window.location="level3.php?level=Water&sublevel=Distribution" title="Distribution (L2)">
		<img class=l1 stage=waste    src=img/waste.png    onclick=window.location="edit.php?level=Waste"                       title="WASTEWATER (L1)"> 
		<img class=l2 stage=wasteCol src=img/wasteCol.png onclick=window.location="level3.php?level=Waste&sublevel=Collection"   title="Collection (L2)">
		<img class=l2 stage=wasteTre src=img/wasteTre.png onclick=window.location="level3.php?level=Waste&sublevel=Treatment"    title="Treatment (L2)">
		<img class=l2 stage=wasteDis src=img/wasteDis.png onclick=window.location="level3.php?level=Waste&sublevel=Discharge"    title="Discharge (L2)">
		|||
...
<style>
	...
	#linearDiagram img.l1 {width:40px;} 
	...
	#linearDiagram #line {position:relative; transform:translateY(-23px) translateX(-78px);z-index:-1;width:430px;}
</style>
