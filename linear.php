...
<style>
	...
	#linearDiagram #line {background-color:#aaa;position:relative; transform:translateY(-26px) translateX(79px);z-index:1;width:270px;}
...
<div id=linearDiagram>
	...
	<!--Summaries-->
	<div>
		<span style="color:#666"><?php write('#summary')?> </span>
