...
for(let i=0;i<3;i++) stages_menu.add_substage('Water','Abstraction').wsa_nrg_cons=1000;
for(let i=0;i<1;i++) stages_menu.add_substage('Water','Treatment').wst_nrg_cons=1000;
for(let i=0;i<2;i++) stages_menu.add_substage('Water','Distribution').wsd_nrg_cons=1000;
for(let i=0;i<3;i++) stages_menu.add_substage('Waste','Collection').wwc_nrg_cons=1000;
for(let i=0;i<2;i++) stages_menu.add_substage('Waste','Treatment').wwt_nrg_cons=1000;
for(let i=0;i<1;i++) stages_menu.add_substage('Waste','Onsite').wwo_nrg_cons=1000;
