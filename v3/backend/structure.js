...
let Structure=[
  {prefix:'ws',  icon:"water.png",    level:'Water', sublevel:false,          class:Water_stages, color:'#58c1db'},
  ...
  {prefix:'ww',  icon:"waste.png",    level:'Waste', sublevel:false,          class:Waste_stages, color:'#ed6d57'},
  ...
  {prefix:'wwo', icon:"wasteOns.svg", level:'Waste', sublevel:'Onsite',       class:Waste_Onsite},
];
