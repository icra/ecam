...
//A "system" or "scenario" is an Ecam object
class Ecam{
  constructor(){
    this.General={
      version              : "3.0.0",
...
class Water_Abstraction extends Substage{
  ...
  //GHG wsa
    ...
    wsa_KPI_GHG_elec(){return this.wsa_nrg_cons*Global.General.conv_kwh_co2}
    wsa_KPI_GHG_fuel(){
...
class Water_Distribution extends Substage{
  ...
  //GHG wsd
    ...
    wsd_KPI_GHG_elec(){return this.wsd_nrg_cons*Global.General.conv_kwh_co2}
    wsd_KPI_GHG_fuel(){
...
class Waste_Treatment extends Substage{
  constructor(name){
    ...
    this.wwd_vol_disc       = 0; //discharged ww volume
    this.wwd_vol_nonp       = 0; //Volume of water reused
    ...
    this.wwd_trck_typ       = 0;
    this.wwd_vol_trck       = 0;
    this.wwd_wr_N_rec       = 0; //N recovered
    this.wwd_wr_P_rec       = 0; //P recovered
    this.wwd_wr_adnrg       = 0; //additional energy
    this.wwd_wr_vol_d       = 0; //volume of reused water displacing potable water
    this.wwt_mass_slu       = 0;
    this.wwt_dryw_slu       = 0;
    this.wwt_slu_disp       = 0;
  ...
  //GHG wwt
    ...
    wwt_KPI_GHG_elec(){return this.wwt_nrg_cons*Global.General.conv_kwh_co2}
    wwt_KPI_GHG_fuel(){
    ...
    wwd_KPI_GHG_trck(){
      let vol   = this.wwd_vol_trck;
      let fuel  = Tables.get_row('Fuel type',this.wwd_trck_typ);
      let co2   = vol*fuel.FD*fuel.NCV/1000*fuel.EFCO2;
      let ch4   = vol*fuel.FD*fuel.NCV/1000*fuel.EFCH4.vehicles*Cts.ct_ch4_eq.value;
      let n2o   = vol*fuel.FD*fuel.NCV/1000*fuel.EFN2O.vehicles*Cts.ct_n2o_eq.value;
      let total = co2+n2o+ch4;
    ...
    wwd_KPI_GHG_disc(){
      let ch4 = this.wwt_bod_effl*this.wwd_ch4_efac*Cts.ct_ch4_eq.value;
      let n2o = this.wwd_n2o_effl/1000*this.wwd_vol_disc*Cts.ct_n2o_eq.value*Cts.ct_ef_eff.value*Cts.ct_n2o_co.value;
      let total = ch4+n2o;
      return {total,ch4,n2o};
    }
  //SL wwt
    ...
    wwd_wr_GHG_avo_N(){ return this.wwd_wr_N_rec*Cts.ct_cr_forN.value; }
    wwd_wr_GHG_avo_P(){ return this.wwd_wr_P_rec*Cts.ct_cr_forP.value; }
    ...
    wwd_SL_ghg_non(){
      return this.wwd_vol_nonp*this.wwd_n2o_effl/1000*Cts.ct_ef_eff.value*Cts.ct_n2o_co.value*Cts.ct_n2o_eq.value;
    }
    wwd_total_m3(){
...
class Waste_Onsite extends Substage{
  ...
  //GHG wwo
    ...
    //biogas
    wwo_KPI_GHG_biog(){
      return (this.wwo_biog_pro-this.wwo_biog_val-this.wwo_biog_fla+this.wwo_biog_fla*Cts.ct_ch4_lo.value/100)*this.wwo_ch4_biog/100*Cts.ct_ch4_m3.value*Cts.ct_ch4_eq.value;
    }
    //treatment
    wwo_KPI_GHG_tre(){
    ...
    //urine
    wwo_KPI_GHG_urine(){
      return this.wwo_N_urine*Cts.ct_n2o_co.value*0.01;
    }
    //wwo total emissions
    wwo_KPI_GHG(){
  ...
  //SL wwo
    wwo_SL_nrg_cost(){return 100*this.wwo_nrg_cost/this.wwo_run_cost}
    wwo_SL_GHG_avoided(){
