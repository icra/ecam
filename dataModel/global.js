...
var Global={
	...
	Water:{
		...
		"Distribution":{
			...
			wsd_main_len:0,
			c_wsd_pmp_pw:function(){return this.wsd_pmp_flow*this.wsd_pmp_head*9.81*1000*0.001/1000}, 
	...
	Waste:{
		...
		"Collection":{
			...
			wwc_KPI_nrg_estm_sav:function(){return this.wwc_KPI_nrg_per_m3()-this.wwc_KPI_nrg_cons_new()}, 
