...
var Global = {
	...
	Water:{
		...
		"Distribution":{
			...
			"wsd_main_len":0,
			"wsd_fri_loss":0,
			c_wsd_nrg_natu:function(){return 9810*this.wsd_vol_dist*(this.wsd_wt_el_no-this.wsd_lo_no_el)/3600000},
			...
			c_wsd_nrg_topo:function(){return 9810*this.wsd_vol_dist*(this.wsd_hi_no_el-this.wsd_av_no_el)/3600000},
