...
var Global={
	...
	Waste:{
		...
		"Treatment":{
			...
			wwt_KPI_GHG_slu:function(){return this.wwt_KPI_GHG_sto_co2eq()+this.wwt_KPI_GHG_inc_co2eq()+this.wwt_KPI_GHG_app_co2eq()+this.wwt_KPI_GHG_stock_co2eq()+this.wwt_KPI_GHG_land_co2eq()},
