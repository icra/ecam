...
var Global = {
	...
	Water:{
		...
		"General":{
			...
			wsg_KPI_GHG_elec:function(){return this.wsg_KPI_nrg_cons()*Global.General.conv_kwh_co2},
		},
	...
	Waste:{
		...
		"General":{
			...
			wwg_KPI_GHG_elec:function(){return this.wwg_KPI_nrg_cons()*Global.General.conv_kwh_co2},
		},
