...
var Info = {
	...
	"wwt_tn_influ":{description:"Influent TN load",magnitude:"Mass",unit:"kg",explanation:"Total nitrogen load in treated effluent prior to discharge during the assessment period. It can be estimated by multiplying the average TN concentration in the influent by the volume entering the plant. If this is done daily and summed over the duration of the assessment period the value will be most accurate.", },
	"wwt_tn_efflu":{description:"Effluent TN load",magnitude:"Mass",unit:"kg",explanation:"Total nitrogen load entering the WWTP during the assessment period. It can be estimated by multiplying the average TN concentration in the influent by the volume entering the plant. If this is done daily and summed over the duration of the assessment period the value will be most accurate.", },
	...
	wwt_KPI_t__A_CF_:{description:"WTPs with AS and Coagulation/Filtration (C/F)",magnitude:"Percent",unit:"%",explanation:"", },
