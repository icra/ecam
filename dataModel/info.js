...
var Info = {
	...
	//l2 to rename
	wwGHG8 :{description:"From fuel engines",                                                 magnitude:"Mass/ser.Pop/time", unit:"kgCO2e/inhab/year", explanation:"Direct CO2 emitted in wastewater stages from on-site engines per serviced population in the area that is the responsibility of the water utility", },
	wwGHG10:{description:"From biogas flaring at the WWTP",                                   magnitude:"Mass/ser.Pop",      unit:"kgCO2e/inhab", explanation:"GHG emissions from biogas flaring at the wastewater treatment plant per serviced population in the area that is the responsibility of the water utility", },
	wwGHG12:{description:"From the discharge of treated effluent to waterbodies",             magnitude:"Mass/ser.Pop",      unit:"kgCO2e/inhab", explanation:"GHG emissions from the discharge of treated effluent to waterbodies per serviced population", },
	wwGHG14:{description:"From the discharge of untreated wastewater to waterbodies",         magnitude:"Mass/ser.Pop",      unit:"kgCO2e/inhab", explanation:"GHG emissions from the discharge of untreated wastewater to waterbodies per serviced population", },
	wwGHG16:{description:"From sludge transport",                                             magnitude:"Mass/ser.Pop",      unit:"kgCO2e/inhab", explanation:"GHG emissions from sludge transport per serviced population", },
	...
	ws_SL_nrg_cost   :{description:"Percentage of costs from energy", magnitude:"Percentage", unit:"%",      explanation:"Proportion of the utility energy costs referred to the total running costs related to urban drinking water system", },
	...
	ww_SL_nrg_cost       :{description:"Percentage of costs from energy",                                          magnitude:"Percentage", unit:"%",      explanation:"Proportion of the utility energy costs referred to the total running costs", },
	...
	ws_KPI_GHG_ne  :{description:"From on-site fuel engines",    magnitude:"Mass",       unit:"kgCO2e", explanation:"GHG Emissions other from electricity consumption in all stages of urban drinking water system", },
	...
	ww_KPI_GHG_ne_engines :{description:"From from engines on-site",                magnitude:"Mass",       unit:"kgCO2e", explanation:"Direct CO2e emitted from on-site engines in wastewater stages based upon sum of CO2, CH4 and N2O emission from stationary combustion ", },
