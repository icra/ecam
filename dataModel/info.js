...
var Info = {
	...
	/* | Service levels | */
	/* +================+ */
	ws_SL_qual_com :{description:"Percentage of quality compliance",           magnitude:"Percentage",         unit:"%", explanation:"Percentage of the total number of treated water tests performed that comply with", },
	ws_SL_pres_ade :{description:"Percentage of supply pressure adequacy",     magnitude:"Percentage",         unit:"%", explanation:"Percentage of delivery points (one per service connection) that receive and are likely to receive adequate pressure", },
	ws_SL_cont_sup :{description:"Continuity of supply",                       magnitude:"Percentage",         unit:"%", explanation:"Percentage of delivery points (one per service connection) that receive and are likely to receive adequate pressure", },
	...
	ws_SL_non_revw :{description:"Non-revenue water by volume",                magnitude:"Percentage",           unit:"%", explanation:"", },	
	ws_SL_auth_con :{description:"Authorized consumption per person per day",  magnitude:"Volume/inhab/time", unit:"L/inhab/day", explanation:"Volume of authorized consumption per serviced person in the service area managed by the undertaking divided by the duration of the assessment period", },
	...
	ws_KPI_GHG     :{description:"Total GHG",    magnitude:"Mass",       unit:"kgCO2e", explanation:"GHG Emissions from non-electricity and electricity consumption ", },
	...
	ww_KPI_GHG            :{description:"Total GHG",    magnitude:"Mass",       unit:"kgCO2e", explanation:"GHG Emissions from non-electricity and electricity consumption"},
	...
	wst_KPI_GHG_elec:{description:"From electricity",         magnitude:"Mass",       unit:"kgCO2e", explanation:"GHG Emissions from electricity consumption in the Treatment stage", },
	...
	wwt_KPI_GHG_elec:{description:"From electricity",         magnitude:"Mass",       unit:"kgCO2e", explanation:"GHG Emissions from electricity consumption in the Treatment stage", },
