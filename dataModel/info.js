...
var Info = {
	...
	//L2 WWT
	"wwt1" :{description:"Influent BOD5 load", magnitude:"Mass", unit:"kg", explanation:"BOD5 load entering the WWTP during the assessment period. It can be estimated by multiplying the average BOD concentration in the influent by the volume entering the plant. If this is done daily and summed over the duration of the assessment period the value will be most accurate", },
	"wwt2" :{description:"Biogas produced", magnitude:"Volume", unit:"Nm3", explanation:"Biogas produced during the assessment period by each wastewater treatment plant managed by the undertaking", },
	"wwt3" :{description:"Biogas valorised", magnitude:"Volume", unit:"Nm3", explanation:"Volume of biogas used to generate electricity or for heating (i.e. the anaerobic digester) at the wastewater treatment plant, over the assessment period", },
	"wwt5" :{description:"Effluent TN load", magnitude:"Mass", unit:"kg", explanation:"Total nitrogen load in treated effluent prior to discharge during the assessment period. It can be estimated by multiplying the average TN concentration in the influent by the volume entering the plant. If this is done daily and summed over the duration of the assessment period the value will be most accurate.", },
	"wwt6" :{description:"Influent TN load", magnitude:"Mass", unit:"kg", explanation:"Total nitrogen load entering the WWTP during the assessment period. It can be estimated by multiplying the average TN concentration in the influent by the volume entering the plant. If this is done daily and summed over the duration of the assessment period the value will be most accurate.", },
	"wwt8" :{description:"Volume of treated wastewater",                                                    magnitude:"Volume",       unit:"m3", explanation:"Volume of treated wastewater by each unit, over the assessment period", },
	"wwt9" :{description:"Total electric energy consumption",                                               magnitude:"Energy",       unit:"kWh", explanation:"Total energy consumed during the assessment period by all wastewater treatment plants managed by the undertaking", },
	"wwt10":{description:"Effluent BOD5 load",                                                                   magnitude:"Mass",         unit:"kg", explanation:"BOD5 load at the effluent of the WWTP during the assessment period. It can be estimated by multiplying the average BOD5 concentration in the effluent by the effluent volume the plant. If this is done daily and summed over the duration of the assessment period the value will be most accurate", },
	"wwt11":{description:"Electrical energy produced from biogas valorization",                             magnitude:"Energy",       unit:"kWh", explanation:"Energy produced from biogas valorization during the assessment period by each wastewater treatment plant managed by the undertaking", },
	"wwt12":{description:"Percentage of methane in biogas",                                                 magnitude:"Percentage",   unit:"%", explanation:"Percent of the methane content in the produced biogas", },
	c_wwt50:{description:"Biogas flared",                                                                   magnitude:"Volume",       unit:"Nm3", explanation:"", },
	c_wwt51:{description:"Nitrous oxide (CO2e) emitted in wastewater treatment plants, expressed as CO2e",  magnitude:"Mass",         unit:"kgCO2e", explanation:"Nitrous oxide (CO2e) emitted in wastewater treatment plants, expressed as CO2e using the conversion factor of 298 kg of CO2 per kg of N2O.", },
	c_wwt52:{description:"CH4 emissions from untreated wastewater direct discharge",                        magnitude:"Mass",         unit:"kgCO2e", explanation:"Indirect CO2e emitted in receiving waters due to nitrogen in wastewater effluent without treatment. Based upon BOD in the WWTP influent multiplied by default emission factor ", },
	c_wwt53:{description:"Total Energy content of biogas valorized in the Co-generator",                    magnitude:"Energy",       unit:"kWh", explanation:"Sum of energy content of biogas used in cogeneration during the assessment period by all wastewater treatment plants managed by the undertaking ", },
	c_wwt54:{description:"BOD5 mass removed",                                                               magnitude:"Mass",         unit:"kg", explanation:"This is calculated from the difference in BOD mass from the influent with BOD mass from the effluent over the assessment period.", },
	c_wwt55:{description:"Indirect CO2e emitted in receiving waters due to nitrogen in wastewater effluent", magnitude:"Mass",         unit:"kgCO2e", explanation:"Indirect CO2e emitted in receiving waters due to nitrogen in wastewater effluent", },
	c_wwt56:{description:"N2O emissions from untreated wastewater direct discharge",                        magnitude:"Mass",         unit:"kgCO2e", explanation:"Indirect CO2e emitted in receiving waters due to nitrogen in wastewater discharged without treatment. Based upon nitrogen in the WWTP influent multiplied by default emission factor ", },
	c_wwt57:{description:"Energy equivalent of fuel usage in the truck to disposal site",                   magnitude:"Energy",       unit:"TJ", explanation:"Energy equivalent of fuel usage in the truck to disposal site. This assumes a truck fuel consumption of 25 L/100km", },
	c_wwt58:{description:"Total annual amount of nitrogen discharged directly to aquatic environment",      magnitude:"Mass",         unit:"kg", explanation:"Indirect CO2e emitted in receiving waters due to nitrogen in wastewater discharged without treatment. Based upon nitrogen in the WWTP influent multiplied by default emission factor ", },
	c_wwt59:{description:"Methane (CO2e) emitted in wastewater treatment plants",                           magnitude:"Mass",         unit:"kgCO2e", explanation:"Methane (CO2e) emitted in wastewater treatment plants ", },
	...
	**/
	...
	// ww l2
	wcE1  :{description:"Energy consumption per conveying wastewater to treatment",                 magnitude:"Energy/Volume", unit:"kWh/m3", explanation:"Percentage of hours when the (intermittent supply) system is pressurised", },
	wcE2  :{description:"Energy consumption of collected wastewater per total energy consumption",  magnitude:"Percent", unit:"%", explanation:"Unit energy consumption per conveyed wastewater to treatment", },
	wcE3  :{description:"Standardised Energy Consumption",                                          magnitude:"Energy/Volume/Head", unit:"kWh/m3/100m", explanation:"Percentage of energy consumed in wastewater collection with regards to the Total energy consumed from the grid and self produced in the water and wastewater systems", },
	...
	wtE1  :{description:"Energy consumption per treated wastewater",                                magnitude:"Energy/Volume", unit:"kWh/m3", explanation:"", },
	wtE2  :{description:"Energy consumption of WWTPs per total energy consumption",                 magnitude:"Percent",      unit:"%", explanation:"Unit energy consumption per treated wastewater in wastewater treatment plants", },
	wtE3  :{description:"Energy consumption per BOD5 mass removed",                                 magnitude:"Energy/Mass",  unit:"kWh/Kg BOD removed", explanation:"Percentage of energy consumed in wastewater treatment with regards to the Total energy consumed from the grid and self produced in the water and wastewater systems", },
	wtE4  :{description:"Energy production from biogas",                                            magnitude:"Energy/Volume", unit:"kWh/m3", explanation:"Unit energy consumption per BOD mass removed in wastewater treatment plants", },
	wtE5  :{description:"Biogas produced per mass removed",                                         magnitude:"Volume/Mass", unit:"Nm3/kg BOD removed", explanation:"Unit energy production per treated wastewater in wastewater treatment plants", },
	wtE6  :{description:"Electrical energy produced per total available energy in biogas",          magnitude:"Percent", unit:"%", explanation:"Unit biogas produced per BOD mass removed in wastewater treatment plants", },
	wtE7  :{description:"Sludge production (total weight)",                                         magnitude:"Mass/Volume", unit:"kg/m3", explanation:"Percentage of the electrical energy produced related to the available energy in biogas", },
	wtE8  :{description:"<span style=color:red>Formula TBD</span> Dry weight in sludge production", magnitude:"Percent", unit:"% DW", explanation:"Unit sludge production per treated wastewater in wastewater treatment plants", },
	wtE9  :{description:"Capacity utilisation",                                                     magnitude:"Percent", unit:"%", explanation:"Percentage of dry weight of sludge that comes out from the WWTP to disposal", },
